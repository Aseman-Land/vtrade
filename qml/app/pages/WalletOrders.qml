...
Item {
    ...
    Label {
        ...
        opacity: 0.7
        text: qsTr("There is no active order") + Translations.refresher
    }

    AsemanListView {
        id: listv
        anchors.fill: parent
        model: Models.WalletOrdersModel {
            id: walletModel
        ...
        delegate: Item {
            ...
            Req.CancelOrderRequest {
                ...
                _walletId: model.wallet_id
                _orderId: model.id
                onSuccessfull: {
                    GlobalSignals.snackbarMessage(qsTr("Order deleted successfully"))
                    GlobalSignals.reloadWallet(model.wallet_id);
                }
            }
                    ...
                    ColumnLayout {
                        ...
                        Label {
                            ...
                            text: {
                                ...
                                return symbolFormat.output + (floater + "").slice(1) + " " + (model.sell_order? model.symbol : model.unit)
                            }
                            ...
                            TextFormater {
                                ...
                                readonly property real value: model.sell_order? model.volume : (model.volume * model.price)
                            }
                        }
                        ...
                        Label {
                            ...
                            TextFormater {
                                ...
                                readonly property real value: model.sell_order? (model.volume * model.price) : model.volume
                            }
                        }
                    }
